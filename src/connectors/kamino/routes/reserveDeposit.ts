...
import type {
  ReserveDepositRequest,
  ReserveDepositReply,
} from '../kamino.interfaces';
import {
  ReserveDepositRequestSchema,
  ReserveDepositReplySchema,
} from '../kamino.interfaces';
...
/** Deposit to Kamino market reserve */
export const reserveDepositRoute: FastifyPluginAsync = async (fastify) => {
  fastify.post<{
    Body: ReserveDepositRequest;
    Reply: ReserveDepositReply;
  }>('/reserve-deposit', {
    schema: {
      description: 'Deposit to Kamino market reserve',
      tags: ['kamino'],
      body: {
        ...ReserveDepositRequestSchema,
        properties: {
...
export default reserveDepositRoute;
